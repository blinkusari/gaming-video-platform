    ...
    <v-app-bar flat app clipped-left>
      ...
      <v-menu offset-y left v-else>
        <template v-slot:activator="{ on }">
          <v-btn small outlined rounded color="purple" depressed v-on="on" class="white--text">
            Profile
          </v-btn>
        </template>
        ...
        <v-card>
          ...
          <v-list>
            ...
            <v-list-item router to="/studio">
              <v-list-item-title>GVP Dashboard</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
                ...
                class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">GVP</v-toolbar-title>
          </v-list-item>
          ...
          <div v-for="parentItem in items" :key="parentItem.header">
            ...
            >
              <v-list-item-avatar rounded v-if="parentItem.header == 'Subscriptions'" class="mr-5">
                {{ i }}
                <v-avatar tile color="purple"
                          v-if="
...
export default {
  data: () => ({
    ...
    links: [
      {text: 'About', link: '#'},
      {text: 'Browse Games', link: 'http://localhost:4200/'},
    ],
    channelLength: 0,
    searchText: ''
    // user: null
